...
function buildFace(name, t, blink) {
  ...
  switch (name) {
    ...
    case "working": { flat(-EX, EY + 0.02); flat(EX, EY + 0.02); dot(0, 0.32, 0.85, "mouth"); dot(-0.09, 0.34, 0.6, "mouth"); dot(0.09, 0.34, 0.6, "mouth"); for (let i = 0; i < 7; i++) { const x = -0.6 + i * 0.2, w = cl(Math.sin(t * 4 - i * 0.7)); F.pts.push({ x, y: 0.86, soft: 0.075, w: 0.22 + 0.78 * w, c: "eye" }); } break; }
